          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px', marginTop: '6px' }}>
              {Object.entries({
                ...
                const iconMap = {
                  website: 'M12 2a10 10 0 100 20 10 10 0 000-20zm0 18c-4.41 0-8-3.59-8-8 0-1.85.63-3.55 1.69-4.9C6.16 8.41 8.9 10 12 10s5.84-1.59 6.31-2.9A7.963 7.963 0 0120 12c0 4.41-3.59 8-8 8zm0-16c-1.66 0-3 1.34-3 3 0 2.21 3 4 3 4s3-1.79 3-4c0-1.66-1.34-3-3-3z',
